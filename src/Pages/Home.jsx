...
const WORDS = ["Student Web2 & Web3 Developer", "Tech Enthusiast"];
const TECH_STACK = ["Rust", "Javascript", "PHP", "Python", "C++", "Kotlin"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/rifqisija123" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/rifqi-tarmono123/" },
  { icon: Instagram, link: "https://www.instagram.com/rifqi_rahtar007/?hl=id" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Menciptakan Website Yang Inovatif, Fungsional, dan User-Friendly untuk Solusi Digital di Tahun 2025.
                </p>
